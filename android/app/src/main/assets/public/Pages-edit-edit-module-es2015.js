...
let EditPage = class EditPage {
    constructor(_route, router, _contact, _builder, _action, toastController, loadingController, nav, _telService, _dirService, _fechaService, _alert) {
        this._route = _route;
        this.router = router;
    ...
    updateCollections() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this._contact.update_Contact(this.contac_Form.value, this.id_contacto);
            yield loading.dismiss();
            yield this.nav.navigateForward('/');
            ...
            if (!this.showTel && this.showLocalTel) {
                ...
                yield this._telService.add_Telefono(this.tel_Form.value);
                yield loading.dismiss();
                yield this.nav.navigateForward('/');
            }
            ...
            if (!this.showDir && this.showLocalDir) {
                ...
                yield this._dirService.add_Direccion(this.dir_Form.value);
                yield loading.dismiss();
                yield this.nav.navigateForward('/');
            }
            ...
            if (!this.showfecha && this.showLocalFecha) {
                ...
                yield this._fechaService.addFecha(this.fecha_Form.value);
                yield loading.dismiss();
                yield this.nav.navigateForward('/');
            }
                ...
                const alert = yield this._alert.create({
                    ...
                    buttons: [{
                            ...
                            role: 'cancel',
                                ...
                                this._telService.get_Telefono(this.id_contacto).subscribe(res => {
                                    res.filter(check => {
                                        this._telService.delete_Telefono(check.id);
                                    });
                                });
                            } },]
                });

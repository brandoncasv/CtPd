...
let CreatePage = class CreatePage {
    constructor(sanitizer, builder, crudService, toastController, loadingController, nav, _telService, _dirService) {
    ...
    save_Contact(createForm) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.showCorreo) {
                yield this.crudService.update_Contact(this.correo_Form.value, this.contact_ID);
            }
            if (this.showDir) {
                ...
                yield this._telService.add_Telefono(this.dir_Form.value).then(() => {
                    loading.dismiss();
                    this.nav.navigateForward('/');
                });
            }

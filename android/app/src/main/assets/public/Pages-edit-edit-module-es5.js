...
var EditPage = /** @class */ (function () {
    function EditPage(_route, router, _contact, _builder, _action, toastController, loadingController, nav, _telService, _dirService, _fechaService, _alert) {
        this._route = _route;
        this.router = router;
    ...
    EditPage.prototype.updateCollections = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this._contact.update_Contact(this.contac_Form.value, this.id_contacto)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, loading.dismiss()];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.nav.navigateForward('/')];
                    case 5:
                        _a.sent();
                        if (this.showTel && !this.showLocalTel) {
                            this._telService.get_Telefono(this.id_contacto).subscribe(function (res) {
                                res.filter(function (check) {
                                    _this._telService.update_Telefono(_this.tel_Form.value, check.id);
                                    loading.dismiss();
                                    _this.nav.navigateForward('/');
                                });
                            });
                        }
                        if (!(!this.showTel && this.showLocalTel)) return [3 /*break*/, 9];
                        this.tel_Form.addControl('id_Contacto', new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.id_contacto));
                    ...
                    case 9:
                        if (this.showDir && !this.showLocalDir) {
                            this._dirService.get_Direccion(this.id_contacto).subscribe(function (res) {
                                res.filter(function (check) {
                                    _this._dirService.update_Direccion(_this.dir_Form.value, check.id);
                                    loading.dismiss();
                                    _this.nav.navigateForward('/');
                                });
                            });
                        }
                        if (!(!this.showDir && this.showLocalDir)) return [3 /*break*/, 13];
                        this.dir_Form.addControl('id_Contacto', new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.id_contacto));
                        return [4 /*yield*/, this._dirService.add_Direccion(this.dir_Form.value)];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, loading.dismiss()];
                    case 11:
                    ...
                    case 13:
                        if (this.showfecha && !this.showLocalFecha) {
                            this._fechaService.getFecha(this.id_contacto).subscribe(function (res) {
                                res.filter(function (check) {
                                    _this._fechaService.updateFecha(_this.fecha_Form.value, check.id);
                                    loading.dismiss();
                                    _this.nav.navigateForward('/');
                                });
                            });
                        }
                        if (!(!this.showfecha && this.showLocalFecha)) return [3 /*break*/, 17];
                        this.fecha_Form.addControl('id_Contacto', new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](this.id_contacto));
                        return [4 /*yield*/, this._fechaService.addFecha(this.fecha_Form.value)];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, loading.dismiss()];
                    case 15:
                    ...
                    case 16:
                        ...
                        _a.label = 17;
                    case 17:
                        if (!(this.showCorreo && !this.showLocalCorreo)) return [3 /*break*/, 21];
                        return [4 /*yield*/, this._contact.update_Contact(this.contac_Form.value, this.id_contacto)];
                    case 18:
                        _a.sent();
                        return [4 /*yield*/, loading.dismiss()];
                    ...
                    case 20:
                        ...
                        _a.label = 21;
                    case 21:
                        if (!(!this.showCorreo && this.showLocalCorreo)) return [3 /*break*/, 25];
                        return [4 /*yield*/, this._contact.update_Contact(this.contac_Form.value, this.id_contacto)];
                    case 22:
                        _a.sent();
                        return [4 /*yield*/, loading.dismiss()];
                    ...
                    case 24:
                        ...
                        _a.label = 25;
                    case 25:
                        console.log(this.contac_Form.value, this.tel_Form.value, this.dir_Form.value, this.fecha_Form.value);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.showTel) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._alert.create({
                                ...
                                buttons: [{
                                        ...
                                        role: 'cancel',
                                            ...
                                            _this._telService.get_Telefono(_this.id_contacto).subscribe(function (res) {
                                                res.filter(function (check) {
                                                    _this._telService.delete_Telefono(check.id);
                                                });
                                            });
                                        } },]
                            })];
    ...
    EditPage.prototype.presentAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {

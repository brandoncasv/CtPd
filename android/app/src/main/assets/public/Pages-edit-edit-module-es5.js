...
var EditPage = /** @class */ (function () {
    function EditPage(_route, router, _contact, _builder, toastController, loadingController, nav, _telService, _dirService) {
        this._route = _route;
        this.router = router;
    ...
    EditPage.prototype.ngOnInit = function () {
        ...
        this._route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
                ...
                console.log(_this.data, _this.data2, Object.values(_this.data3[0]));
            }
        });
    ...
    EditPage.prototype.obtainData = function (array) {
    };

            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this._telService.add_Telefono(this.tel_Form.value).then(function () {
                                loading.dismiss();
                                _this.nav.navigateForward('/');
                            })];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.crudService.update_Contact(this.correo_Form.value, this.contact_ID).then(function () {
                                loading.dismiss();
                                _this.nav.navigateForward('/');
                            })];
                    case 6:

...
var DetailsContactPage = /** @class */ (function () {
    function DetailsContactPage(route, _telefono, _contact, _direccion, _loadingController, _nav, _router, _fecha, _alert) {
        this.route = route;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        this.fechas.filter(function (check) {
                            if (check.id_Contacto !== '') {
                                _this._fecha.deleteFecha(check.id);
                            }
                        });
                        return [2 /*return*/];
                }
    ...
    DetailsContactPage.prototype.presentAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this._router.navigate(['edit'], navigationExtras)];
                    case 4:
                        _d.sent();
                        return [2 /*return*/];
                }
...
var FechaService = /** @class */ (function () {
    ...
    FechaService.prototype.deleteFecha = function (id) {
        return this.fechas_Collection.doc(id).delete();
    };
    FechaService.prototype.updateFecha = function (fecha, id) {
